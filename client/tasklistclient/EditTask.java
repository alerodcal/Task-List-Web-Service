...
public class EditTask extends JDialog {
	...
	public static void main(String[] args) {
		try {
			EditTask dialog = new EditTask(1,"task","10/10/2001",false,null);
	 ...
	 * Create the dialog.
	 */
	public EditTask(int id, String task, String dueDate, Boolean done, String list) {
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						client.editTask(id, tf_task.getText(), tf_dueDate.getText(), done, list);
						client.hideEditTaskPanel();
					}
				});
