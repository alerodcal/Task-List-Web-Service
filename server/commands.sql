...
--Insert new list
INSERT INTO taskList.example_taskLists VALUES (default,'taskList1');
CREATE TABLE taskList.example_taskList1 (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
	task VARCHAR(256) NOT NULL, 
	duedate VARCHAR(30), 
	done BOOLEAN DEFAULT false);
--Insert new task
INSERT INTO taskList.example_taskList1 VALUES (default,'example Task 2', '15/06/2016', true);
